...
/** Convert a human amount string like "5.5" to minor units string "5500000" */
export function humanToMinor(human: string, decimals = 6): string {
...
export function minorToHuman(minor: string, decimals = 6): string {
